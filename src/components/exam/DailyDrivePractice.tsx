...
export default function DailyDrivePractice({onChooseGemini,onChooseAll}:DailyDrivePracticeProps){
  ...
  return <section className="daily-drive panel" aria-label="Ôn tập nhanh hằng ngày từ Đề HIU hoặc Đề Gemini">
    ...
    {!session?<div className="daily-drive__start"><b>{guest?'Đăng nhập để ôn tập':config?.ready?'Chọn thư mục và số câu để học.':'Chưa có câu đã xác minh.'}</b></div>:session.ready&&current?<div className="daily-drive__practice">
