export type ThemeName='duoc-ngoc'|'muc-tuyen'|'ngu-y'|'tcm-cartoon-2d';
export const THEME_OPTIONS:{id:ThemeName;name:string;description:string;swatches:string[]}[]=[
  ...
  {id:'tcm-cartoon-2d',name:'YHCT Hoạt hình 2D',description:'Ngọc bích tươi, vàng hoàng cúc, chu sa dịu và cam quế; vector phương Đông trẻ trung, chuyển đổi tức thời không tải lại trang.',swatches:['#159A84','#F5C453','#C8554F','#D9824A']}
];
