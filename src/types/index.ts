...
export const BRANDING:Branding={owner:'Trường Đại Học Quốc Tế Hồng Bàng',faculty:'Khoa Y',platformName:'YHCT HIU 4.0',subtitle:'Mạng xã hội Học thuật & Luyện thi Y học Cổ truyền',logoUrl:'/logo-clb-yhct-hiu.svg',defaultAdminTitle:'Chủ nhiệm CLB'};
