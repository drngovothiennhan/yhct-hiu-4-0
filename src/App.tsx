...
import { Bell,BookOpen,CalendarDays,Compass,FlaskConical,GraduationCap,Home,LogIn,LogOut,Medal,Menu,Plus,ShieldCheck,Star,UserRound,X } from 'lucide-react';
...
type MobileUi='social'|'classic';
const MOBILE_UI_KEY='yhct-mobile-ui-v1';
...
const readMobileUi=():MobileUi=>{try{return localStorage.getItem(MOBILE_UI_KEY)==='classic'?'classic':'social'}catch{return'social'}};
...
export default function App(){
  ...
  const toggleMobileUi=()=>{setMobileUi(x=>x==='social'?'classic':'social');setMoreOpen(false)};
