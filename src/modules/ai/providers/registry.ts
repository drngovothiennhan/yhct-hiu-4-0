...
export const aiProviderRegistry:AiProviderDescriptor[]=[
  ...
  {id:'europe-pmc',label:'Europe PMC',kind:'academic-search',state:'candidate',zeroInstallCost:true,networkRequired:true,capabilities:['biomedical-search','full-text-links','grants'],note:'Recommended biomedical/open-access search adapter.'},
  {id:'crossref',label:'Crossref REST',kind:'academic-search',state:'candidate',zeroInstallCost:true,networkRequired:true,capabilities:['doi-metadata','reference-resolution'],note:'Recommended DOI/metadata adapter; public REST access does not require registration.'},
