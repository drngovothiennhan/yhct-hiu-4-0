...
const checks=[
  ...
  ['system AI warning is compact, typographically even and placed directly below bulletin preface',css.includes('.system-ai-note')&&css.includes('font-size:.68rem!important')&&css.includes('.system-ai-note>b{font-size:inherit;line-height:inherit')&&post.indexOf('system-ai-preface')<post.indexOf('system-ai-note')&&post.indexOf('system-ai-note')<post.indexOf('system-ai-main')],
