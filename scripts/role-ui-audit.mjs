...
const files={
 ...
 css:read('src/viewport-native-hotfix.css')+read('src/news-rotator.css')+read('src/final4-v2.css')+read('src/social-v5.css')+read('src/garden-v6.css')+read('src/module-isolation.css'),
 news:read('src/components/news/TcmNewsRotator.tsx'),community:read('src/components/community/CommunitySidebar.tsx'),admin:read('src/components/admin/SystemAdminCenter.tsx'),adminControl:read('src/components/admin/AdminControlCenter.tsx'),adminTheme:read('src/components/admin/AdminThemeControl.tsx'),moderation:read('src/components/admin/ModerationOpsPanel.tsx'),drl:read('src/components/drl/DrlCenter.tsx'),worker:read('src/workers/drlParseWorker.ts'),feed:read('src/components/feed/AcademicFeed.tsx'),post:read('src/components/feed/AcademicPostCard.tsx'),mini:read('src/components/ai/UnifiedAiMini.tsx'),docx:read('src/components/feed/DocxImportPanel.tsx'),types:read('src/types/index.ts'),theme:read('src/theme.ts'),profile:read('src/components/profile/ProfileCenter.tsx'),profileInbox:read('src/components/profile/ProfileInbox.tsx'),auth:read('src/services/authService.ts'),authRuntime:read('src/services/authRuntimeService.ts'),garden:read('src/components/game/HerbGardenGame.tsx'),gardenSocial:read('src/components/game/HerbGardenSocialHub.tsx'),messages:read('src/components/messages/MessagesCenter.tsx'),composer:read('src/components/feed/AcademicPostComposer.tsx'),vite:read('vite.config.ts'),main:read('src/main.tsx'),contract:read('src/modules/moduleContract.ts'),pwa:read('src/services/pwaInstallService.ts'),settings:read('src/components/system/AppSettingsDialog.tsx'),research:read('src/components/research/ResearchCenter.tsx'),researchMini:read('src/components/research/ResearchAiMini.tsx')
};
...
const checks=[
 ...
 ['USER',[
  ...
  ['OpenAlex restored to research and AI mini',has(files.research,'searchOpenAlex(query,12)','A.I OpenAlex tổng hợp')&&has(files.researchMini,'searchOpenAlex(text,6)')&&has(files.mini,'searchOpenAlex','academicIntent')],
