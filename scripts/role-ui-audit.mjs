...
const checks=[
 ...
 ['USER',[
  ...
  ['AI Mini is application assistant without research or feedback overlap',has(files.mini,'Trợ lý ứng dụng','askXiaoZhiMini','researchIntent','openResearch(text)','VOICE_KEY','startListening')&&has(files.miniService,"mode:'xiaozhi-mini'",'hiu.vn','fanpage chính thức')&&not(files.mini,'askAcademicUnified','feedback_submit_v1','searchOpenAlex','searchPubMed','searchClinicalTrials','searchDriveRag','searchKnowledge')&&not(files.app,'AiMiniFeedbackDock','PersonalCopilotWidget')],
...
console.log('role-audit-ok: modular roles, scoped learning management, atomic theme, rolling TCM news carousel, latest-three AI academic posts, private inbox, application assistant, PWA, wall identity, moderation, garden, DRL and RBAC contracts passed');