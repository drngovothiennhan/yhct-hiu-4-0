...
forbid(themeControl,/option\.description|Chỉ ACC\/Admin thay đổi|module khác chỉ nhận theme/,'system appearance control must stay compact without explanatory copy');
