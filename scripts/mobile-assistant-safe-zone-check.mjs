...
need('top:20px!important','mobile assistant top safe zone');
...
console.log('Mobile assistant safe-zone PASS: mascot is fully docked inside the 64px top app bar, cannot roam over study content, and panel clears bottom navigation.');
