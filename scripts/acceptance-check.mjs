...
const required=[
  ...
  'src/services/academicTranslationService.ts','src/services/driveRagService.ts','src/services/examSessionService.ts','src/services/xiaozhiMiniService.ts','src/services/studyAiService.ts',
