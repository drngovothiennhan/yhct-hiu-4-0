...
need(auth,['herbal_alias','herbalAlias','wall_theme','wall_motto','readSessionResilient','auth_user_id','loadMemberFromSession','2600,4500,6500','attempt<2'],'refresh-safe herbal identity session restore');
