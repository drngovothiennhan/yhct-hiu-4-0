...
requireText(state,'PHASE 12 — FINAL MULTI-VIEWPORT QA + PRODUCTION VERIFICATION — ACTIVE','execution state');
requireText(state,'No business logic, RBAC, data, quiz approval, AI contracts or game progression changes are permitted in Phase 12.','execution state');
...
console.log('Phase 12 final QA contract PASS: execution state, performance boundary, multi-viewport Chrome CI and exact-SHA production gates are wired.');
