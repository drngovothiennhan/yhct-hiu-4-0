...
console.log(`Phase 17 version convergence: PASS · sole Study OS Home · shared Study gateway · task-only XiaoZhi · V20 clinic · release-aware PWA · ${entries.length}/12 functions`);
