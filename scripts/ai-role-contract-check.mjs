...
need(quizManager,['Ngân hàng đề thi','syncQuizBank','Thêm thủ công → Cập nhật → dùng ngay','thư mục môn','Tên thư mục môn là nội dung người học nhìn thấy','DOCX và Google Docs được chuẩn hóa','đáp án tô đỏ'],'canonical one-step subject-folder quiz bank manager');
