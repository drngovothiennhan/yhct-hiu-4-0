...
const app=read('src/App.tsx'),contract=read('src/modules/moduleContract.ts'),feed=read('src/components/feed/AcademicFeed.tsx'),composer=read('src/components/feed/AcademicPostComposer.tsx'),types=read('src/types/index.ts'),themeControl=read('src/components/admin/AdminThemeControl.tsx'),device=read('src/services/deviceCapability.ts'),mini=read('src/components/ai/UnifiedAiMini.tsx'),profile=read('src/components/profile/ProfileCenter.tsx'),profileInbox=read('src/components/profile/ProfileInbox.tsx'),messages=read('src/components/messages/MessagesCenter.tsx'),auth=read('src/services/authService.ts'),moderation=read('src/components/admin/ModerationOpsPanel.tsx'),systemAdmin=read('src/components/admin/SystemAdminCenter.tsx'),memberAdmin=read('src/components/admin/AdminControlCenter.tsx'),pwa=read('src/services/pwaInstallService.ts'),settings=read('src/components/system/AppSettingsDialog.tsx'),research=read('src/components/research/ResearchCenter.tsx'),researchMini=read('src/components/research/ResearchAiMini.tsx');
...
need(mini.includes('searchDriveRag')&&mini.includes('searchOpenAlex')&&mini.includes('academicIntent'),'AI Mini shares Drive RAG and OpenAlex retrieval');
